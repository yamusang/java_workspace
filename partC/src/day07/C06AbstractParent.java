...
public class C06AbstractParent {
    public static void main(String[] args) {
        ...
        // 내부 익명 클래스 : 여기서 new 연산의 {} 안에 메소드 재정의하면 익명 클래스입니다.. (일회용)
...
// 자식클래스가 Animal을 구체화(추상메소드 재정의)시켜 객체를 생성하도록 합니다.
...
class Cat extends Animal {
    ...
    // => 해결 방법 : 커스텀 생성자 (다른 해결방법은 기본생성자 직접 정의)
