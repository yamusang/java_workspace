public class DataTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("weight:"+weight); //+는 문자열에서 연결 연산
        System.out.println("isAdult:"+isAdult); //+는 문자열에서 연결 연산
        System.out.println("isAdult:"+(isAdult?"성인":"청소년")); //+는 문자열에서 연결 연산
        System.out.println("gender:"+gender); //+는 문자열에서 연결 연산
        System.out.println("name:"+name); //+는 문자열에서 연결 연산
